...
DELETE FROM FW_SQL WHERE KEY = 'FILEDOWNLOAD_01';
insert into FW_SQL (KEY, SQL) VALUES ('FILEDOWNLOAD_01', 'INSERT INTO FW_FILE_DOWNLOAD (
FILE_ID
, ID
, ST_DTM
, ED_DTM
...
DELETE FROM FW_CONTROLLER WHERE KEY = 'filedownload';
INSERT INTO FW_CONTROLLER VALUES ('filedownload','com.code5.fw.web.MasterControllerMultipart','fileDownload','Y','');

DELETE FROM FW_VIEW WHERE KEY = 'fileDownload'; 
